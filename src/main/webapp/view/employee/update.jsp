...
<div class="overlay">
    <form action="/employee?action=update&id=${employee.getId()}" method="post" id="form-1">
        <div class="con">
            <header class="head-form">
                <h2>Sửa thông tin nhân viên</h2>
                <p>Nhập các thông tin nhân viên cần sửa</p>
            </header>
            <br>
            <div class="field-set">
                <div class="mb-2">
                ...
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control" id="citizenId" name="citizenId"
                           value="${employee.getCitizenId()}" pattern="^[0-9]{9}$">
                </div>
                <div class="mb-2">
                ...
                <button class="log-in" type="submit" onclick="notify()">Thay đổi thông tin</button>
            </div>
        </div>
    </form>
</div>
